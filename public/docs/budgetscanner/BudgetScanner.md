...
3. **Wijs betalingen toe** aan budgetpotjes; geef daarbij de kern op uit de naam van de tegenpartij; alle betalingen van dezelfde tegenpartij worden dan automatisch aan hetzelfde potje gekoppeld.
4. **Bekijk** het rapport en lees precies hoeveel je per potje hebt uitgegeven of ontvangen.
...
Werk je met [ZIP/XML](#zipxmlcamt053), dan laad je je bankbetalingen in. Werk je met [PMB](#pmb-bestand), dan kun je meestal direct verder waar je eerder was gebleven. Kies bij voorkeur een heel jaar, zodat je een compleet beeld krijgt.
...
![Overzicht van [Toewijzingsregels](#toewijzingsregels) met patronen per [categorie](#categorie) en [potje](#potje)](images/h4-toewijzingsregels.png)

#### Opslaan

Bij *Opslaan* kun je twee soorten bestanden bewaren:

- **PMB**: dit is je werkbestand. Hierin staan alle [betalingen](#betaalgroep), [koppelingen](#toewijzen), regels en [potjes](#potje) die je hebt gemaakt. Wil je later verdergaan? Upload dan je opgeslagen [PMB](#pmb-bestand) opnieuw in [stap 2: Uploaden](#3-stap-2-bestanden-uploaden). Dan ga je verder waar je was gebleven toen je het bestand bewaarde.
...
Sla regelmatig op. Als je per ongeluk de pagina sluit nadat je dingen hebt gewijzigd, worden wijzigingen niet bewaard. Je browser waarschuwt je dan. Klik dan op Annuleren en sla op als [PMB](#pmb-bestand).

Tip: in de naam van het [PMB](#pmb-bestand)-bestand zitten de datum en tijd wanneer je het hebt opgeslagen. Op die manier kun je makkelijker een specifieke versie terugvinden.
...
De voortgangsbalk daaronder geeft met kleuren weer hoever je bent: groen = klaar, oranje = nog geen potje toegewezen, rood = nog geen categorie (en dus ook geen potje) toegewezen. Als balk helemaal groen is ben je klaar!
...
### 4.4. Filteren en sorteren {#44-filteren-sorteren}
...
![Filteren, sorteren](images/h4-filteren-sorteren.png)

Het lijkt nu waarschijnlijk wat overweldigend, al die mogelijkheden. Het goede nieuws is: je kunt niets kapot maken! Als je een bestand met [betalingen](#betaalgroep) van de bank hebt gedownload, kun je dat telkens opnieuw uploaden in stap 2. Als je voor het uploaden de knop 'Uploads wissen' gebruikt kun je echt opnieuw beginnen. Als je een punt hebt bereikt dat je denkt: 'dit begint ergens op te lijken', sla je het op als [PMB](#pmb-bestand). Hoe dat werkt, lees je in [paragraaf 4.1](#41-knoppen-toewijzingsregels-en-opslaan). Ook met zo'n PMB bestand kun je telkens opnieuw beginnen. Alles wat je had gedaan toen je bestand bewaarde neem je dan ook nog mee.
...
Als je in het *Zoeken*-veld een deel van een naam invult, blijven in de lijst met [betalingen](#betaalgroep) alleen [betalingen](#betaalgroep) over met dat zoekwoord in de naam, het potje of het bedrag.

![Zoeken](images/h4-toewijzen-jumbo-voor.png)

#### Toewijzen zonder regel

Voor sommige [betalingen](#betaalgroep) wil je helemaal geen regel maken om [toe te wijzen](#toewijzen). In de paragraaf [Toewijzingsregels](#toewijzingsregels) staat meer informatie over die regels. Als je op vakantie in een barretje wat hebt gedronken, hoeft dat later nooit meer [toegewezen](#toewijzen) te worden. Eén keer en nooit weer. Je hebt daar wel geld uitgegeven en wilt het ook aan een [potje](#potje) [toewijzen](#toewijzen), maar [zonder regel](#toewijzen-zonder-regel). 
...
[Toewijzen zonder regel](#toewijzen-zonder-regel) is erg handig als je er bijna bent: je hebt bijna alles [toegewezen](#toewijzen), maar er blijven losse [betalingen](#betaalgroep) over. Je kiest het tabblad [Onbekend](#onbekend), selecteert ze allemaal en [koppelt](#toewijzen) ze allemaal aan één [potje](#potje). 
...
### 4.5. De betalingen toewijzen aan een potje met een regel
...
![Toewijzingsregel](images/h4-potjes-toewijzen.png)

Klik op een betaalgroep om [toe te wijzen](#toewijzen). Het 'Potjes [toewijzen](#toewijzen)'-schermpje verschijnt. In de volgende paragraven lopen we stuk voor stuk de verschillende onderdelen van het Potjes [toewijzen](#toewijzen)'-schermpje af.

#### Toewijzingsregel

De Toewijzingsregel is een deel van een naam. Gewoonlijk is het een deel waarmee de naam begint Dat de Toewijzingsregel moet beginnen met de opgegeven letters is goed te verklaren. Als je zou zoeken op NS en je vindt alle namen met de letters ns in de naam, krijg je ook Vitens, Transavia en heel veel anderen.

Als je een deel van de naam wil gebruiken dat middein zit kun je de Toewijzingsregel laten beginnen met een sterretje (*). Dan doet het er niet toe waar de Toewijzingsregel voorkomt in de naam.

Alle betalingen waarvan de naam van de tegenpartij voldoet aan de Toewijzingsregel worden automatisch aan hetzelfde potje toegewezen als de betaling(groep) waar je de regel nu opneemt.
...
Om met dat 'bijna' te beginnen: als je uit bent geweest, jij hebt betaald, en je hebt Tikkies gestuurd, dan rekenen we die [betalingen](#betaalgroep) niet tot [inkomsten](#inkomsten). Die [wijs](#toewijzen) je toe aan het [potje](#potje) waar je de [betaling](#betaalgroep) aan hebt [toegewezen](#toewijzen). Wat dan overblijft, is precies wat je zelf hebt uitgegeven. 
...
Naast de Toewijzingsregel en de [Categorie](#categorie) moet de [betaalgroep](#betaalgroep) ook nog aan een [potje](#potje) worden [toegewezen](#toewijzen). Dat doe je in het onderste veld.

Als je een [categorie](#categorie) hebt gekozen en je klikt in het [Potje](#potje)-veld, zie je alle [potjes](#potje) die nu al aan die [categorie](#categorie) zijn [toegewezen](#toewijzen). 
...
Pas wel op voor spelfouten. Als je een bestaand [potje](#potje) op een andere manier spelt, wordt het een nieuw [potje](#potje). Dat is dan niet de bedoeling. Je kunt met [Toewijzingsregels](#toewijzingsregels) het verkeerd gespelde [potje](#potje) de goede naam geven. Dan is het weer opgelost.
...
#### ZIP/XML/CAMT.053 {#zipxmlcamt053}
